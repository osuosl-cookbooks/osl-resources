...
action :create do
  directory get_override_dir do
    recursive true
  end

  file ::File.join(get_override_dir, "#{new_resource.override_name}.conf") do
